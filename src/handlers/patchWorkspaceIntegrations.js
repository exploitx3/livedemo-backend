...
import patchWorkspaceIntegrationsValidator from '../helpers/validators/oldLambdaRoutes/workspaces/patchWorkspaceIntegrationsValidator.js'
...
const handler = function (req, res) {
  ...
  return Promise.resolve().then(async () => {
    ...
    .then(({ authUser }) => {
      ...
      let validatedBody = helpers.validateBody(req.body, patchWorkspaceIntegrationsValidator)
    ...
    .then(async () => {
      ...
      if (hubspot !== undefined) {
        updateObj['integrations.hubspot'] = hubspot
      }
