...
import postCustomHeaderValidator from '../helpers/validators/stories/custom/postCustomHeaderValidator.js'
...
const handler = function (req, res) {
  ...
  return Promise.resolve().then(async () => {
    ...
    .then(({ authUser }) => {
      ...
      let validatedBody = helpers.validateBody(req.body, postCustomHeaderValidator)
    ...
    .then(async () => {
      ...
      let personName = requestBody.personName
